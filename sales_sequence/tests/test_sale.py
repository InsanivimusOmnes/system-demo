...
class SomethingCase(TransactionCase):
    def setUp(self):
        ...
        self.sale_order_1 = SaleOrder.create({"name": "Sale Order 1"})
    ...
    def test_add_line(self):
        ...
        self.assertEqual(
            self.sale_order_line_4.numbers,
            "4",
